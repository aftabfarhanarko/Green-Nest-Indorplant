      ...
      {navegit.state === "loading" ? (
        ...
        <main className="bg-gradient-to-br from-emerald-50 to-white">
          <div className="min-h-screen flex items-center justify-center  p-6 w-11/12 mx-auto">
            ...
            >
              <div className="p-6 py-15  flex flex-col items-center text-center">
                <img
                  src={user?.photoURL}
                  ...
                  <form onSubmit={handelRegister}>
                    {forms ? (
                      <fieldset className="fieldset">
                        <h1 className="text-[15px] text-lime-600 animate-pulse font-semibold"></h1>
                        {/* Name */}
                    ...
                    <div className="  gap-1 md:gap-3">
                      ...
                      >
                        <FaUserEdit /> {forms ? "Done" : "Change Your Profile"}
                      </button>
